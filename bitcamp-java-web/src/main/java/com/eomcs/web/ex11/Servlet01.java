...
public class Servlet01 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    // => 생성한 세선의 ID는 쿠키를 통해 응답할 때 웹브라우저로 보낸다
    // => HTTP 응답 프로토콜
    //
    // Connection: keep-alive
    // Content-Length: 45
    // Content-Type: text/plain;charset=UTF-8
    // Date: Wed, 08 Apr 2020 03:11:10 GMT
    // Keep-Alive: timeout=20
    // Set-Cookie: JSESSIONID=565C5769E2C5345098A592940EB7FD82; Path=/bitcamp-java-web; HttpOnly
    // Set-Cookie는 쿠키를 생성할 때, 처음 요청했을때만 나타낸다.
