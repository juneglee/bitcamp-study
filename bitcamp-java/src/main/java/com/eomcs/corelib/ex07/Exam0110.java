...
// ☞ 차이점 => arraylist와 linkedlist일때는 equals()로 비교한다
...
//
// ☞ list는 순서대로 저장하고 출력하는 반면, hashset은 순서대로 저장하지 않는다
public class Exam0110 {
  public static void main(String[] args) {
    ...
    set.add(v4);
    set.add(v5);
    // v5와 v3는 서로 다른 인스턴스이지만 두 객체에 들어있는 문자열은 같다.
    ...
    System.out.println(v3.hashCode() + "," + v5.hashCode()); // 98307,98307
    System.out.println("-------------------");
    print(set);
  }
