...
public class Exam0310 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // HTTP 프로토콜을 좀더 정밀하게 제어하고 싶다면 Apache의 HttpClient 라이브러리를 사용하라
    // 단순한 것을 제어할 때는 110을 사용하고 복잡한 것을 제어 한다면 310을 사용
    // HttpClient, HttpGet 등 클래스
    // => www.apache.org 사이트에서 제공하는 HttpComponent 라이브러리에 들어 있는 클래스이다.
    // => 사용하려면 먼저 외부 라이브러리를 프로젝트로 가져와야 한다.
    // 1) mavenrepository.com 에서 apache httpclient 키워드로 검색한다.
