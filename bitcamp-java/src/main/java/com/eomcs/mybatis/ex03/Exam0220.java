...
public class Exam0220 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // 실행 예:
    // => 게시글 변경하기
    // => 제목만 바꿀경우 , 내용만 바꿀 경우, 둘다 바꿀 경우에 대해
    // 각각의 update SQL을 준비하다
    ...
    // dynamic sql를 사용하지 않으면 위처럼 각각 sql문을 만들어 사용해야 한다

    // 실무
    // => 특정 걸럼의 값만 바꾸기 위해 여러 개의 SQL을 만드는 것은 번거롭다.
    // => 그래서 전체 컬럼의 값을 바꾸는 방식을 주로 사용한다
    // 문제점
    // => 바꾸지 않아도 될 항목까지 변경하기 때문에 성능이 떨어진다.
    //
