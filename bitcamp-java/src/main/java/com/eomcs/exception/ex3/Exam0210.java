...
public class Exam0210 {
  ...
  // 오류를 던진다면 반드시 메서드 선언부(호출자에게 알려줌)에 어떤 오류를 던지는지 선언해야 한다.
  static void m1() throws Throwable {
    throw new Throwable(); // OK!
  }
  // Throwable을 선언 못하는 것은 아니지만,
  // 예외를 던질 때는 Throwable 클래스를 직접 사용하지 말고, 하위 클래스를 사용하라
  // 특히 애플리케이션 오류를 의미하는 Exception을 사용하라
