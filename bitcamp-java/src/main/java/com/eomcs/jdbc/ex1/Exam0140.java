...
public class Exam0140 {
  ...
  public static void main(String[] args) {
    ...
    // => 시스템 프로퍼티? JVM 에 설정된 "key=value" 이다.
    ...
    // java- djdbc.driver=클래스명:클래스명:클래스명 Exam0140
    //
    // => 예2) 프로그램 코드에서 설정
    // System.getProperty("jdbc.drivers", "com.eomcs.jdbc.ex1.MyDriver");
    //
    System.getProperty("jdbc.drivers", "com.eomcs.jdbc.ex1.MyDriver:org.mariadb.jdbc.Driver");
