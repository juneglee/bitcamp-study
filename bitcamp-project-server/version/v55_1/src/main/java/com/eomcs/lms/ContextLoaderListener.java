...
// 즉 이 클래스는 서블릿 컨테이너 시작과 종료에 대해 알림을 받는다
...
public class ContextLoaderListener implements ServletContextListener {
  ...
  public void contextInitialized(ServletContextEvent sce) {
    // 서블릿 컨테이너가 실행할 때
    // 실행한 사시실을 알리기 위하여 ServletContextListener에 대해
    // 이 메서드를 호출한다
    ...
    try {
      ...
      // 서블릿이 사용할 수 있게 ServletContext 맵에 담아 둔다.
      ...
      // 현재 Spring IoC 컨테이너에 들어 있는 객체를 확인해 보자
