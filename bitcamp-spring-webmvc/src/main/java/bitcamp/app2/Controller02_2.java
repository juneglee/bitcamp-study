...
public class Controller02_2 {
  ...
  public String handler2(//
    ...
    // => UrlPathHelper 객체의 removeSemicolonContent 프로퍼티 값을 false(default)로 설정한다.
    ...
    // => @MatrixVariable("name") : kim
    // => @MatrixVariable("age") : 20
    return String.format("value:%s \n name:%s, lesson:%d, age:%d", value, name, age);
  }
  ...
  public String handler3(
      ...
      @MatrixVariable String name, @MatrixVariable int qty, @MatrixVariable String title,
