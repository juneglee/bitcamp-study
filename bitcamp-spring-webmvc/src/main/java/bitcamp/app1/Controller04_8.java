...
public class Controller04_8 {
  ...
  // => Servlet API 에서 제공하는 Part 사용하거나
  ...
  // spring WebMVC 설정 MultipartResolver 객체를 등록해야 한다.
  //
  // 테스트:
  // http://.../html/app1/c04_8.html
  ...
  public String handler2(//
    ...
    if (!photo.isEmpty()) {
      ...
      String path = sc.getRealPath("/html/app1/" + filename);
      // /html/app1/ 실제 저장위치
      photo.transferTo(new File(path)); // 파일 객체로 담아서 리턴해야 한다.
    }
  ...
  public String handler3(//
      ...
      MultipartFile[] photo// 포토파일이 여러개 일때
  ) throws Exception {
